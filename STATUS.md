...
6. **Fork Audits Completed**:
   - `MANTRA-Chain/cosmos-sdk@v0.53.8-v8-mantra-1` (the currently-pinned tag, commit `58cc2eb4a66f`) vs upstream `v0.53.8` documented in `docs/proof/fork-audit-cosmos-sdk.md`. Supersedes the original `v0.53.6-v8-mantra-1` vs `v0.53.6` audit, retained in the same document as the baseline diff.
